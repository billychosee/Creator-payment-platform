      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            New accounts can only be created in our mobile app. Download it
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <AppStoreButton size="lg" className="w-full" url="#" />
            <PlayStoreButton size="lg" className="w-full" url="#" />
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Already have an account? You can continue using the web app to
