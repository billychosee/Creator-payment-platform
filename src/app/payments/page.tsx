...
export default function PaymentsPage() {
  const [activeTab, setActiveTab] = useState<"payment-links" | "transactions" | "payouts">("payment-links");
      ...
      <div className="space-y-8 animate-fade-in px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 max-w-4xl">
            {activeTab === "payment-links" && <PaymentLinksContent />}
...
function PaymentLinksContent() {
  ...
  const paymentLinks = [
    ...
    function setShowPaymentLinkModal(arg0: boolean): void {
              ...
              <tbody>
                {paymentLinks.map((link) => (
                  <tr key={link.id} className="border-b border-border">
                    ...
                    <td className="py-4 px-4 font-mono text-sm">{link.reference}</td>
                    ...
                    <td className="py-4 px-4 text-sm text-muted-foreground">{link.created}</td>
                    <td className="py-4 px-4">
                      <div className="flex gap-2">
              ...
              <tbody>
                {transactions.map((transaction) => (
                  <tr key={transaction.id} className="border-b border-border">
                    ...
                    <td className="py-4 px-4 text-sm text-muted-foreground">{transaction.from}</td>
              ...
              <tbody>
                {payouts.map((payout) => (
                  <tr key={payout.id} className="border-b border-border">
                    ...
                    <td className="py-4 px-4 text-sm text-muted-foreground">{payout.requested}</td>
                    <td className="py-4 px-4 text-sm text-muted-foreground">{payout.completed}</td>
                  </tr>
                ))}
              </tbody>
            </table>
